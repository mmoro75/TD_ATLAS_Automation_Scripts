...
def main():
    ...
    username = "root"
    password = sys.argv[2]
    docker_name = sys.argv[3]
    file_to_find = sys.argv[4]

    if file_to_find == 'Custom':
        custom_file_to_find = sys.argv[5]
    else:
    ...
    try:
        ...
        download_path = os.path.join("C:\\Users\\U6017127\.jenkins\\workspace\\Venue_Find_File\\", f"{hostname}-{docker_name}")
